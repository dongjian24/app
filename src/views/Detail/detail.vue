    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <MyZoom :skuDefaultImg="skuInfo.skuDefaultImg" />
          <!-- 小图列表 -->
            ...
            <div class="chooseArea">
              ...
              <dl v-for="spu in spuSaleAttrList" :key="spu.id">
                ...
                <dd
                  ...
                  @click="chooseSpu(spuValue, spu.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                />
                <a @click="addNum" class="plus">+</a>
                <a @click="reduceNum" class="mins">-</a>
              </div>
              <div class="add">
...
import MyZoom from "./Zoom/Zoom.vue";
...
export default {
  ...
  methods: {
    chooseSpu(spuValue, spuValueList) {
      spuValueList.forEach((item) => {
        item.isChecked = 0;
      });
    ...
    async addCart() {
      ...
      try {
        ...
        //路由跳转 简单的数据skuNum通过query形式给路由组件传递过去
        //复杂的skuInfo通过会话存储
        sessionStorage.setItem("SKUINFO", JSON.stringify(this.skuInfo));
        this.$router.push({
          name: "addcartsuccess",
          query: { skuNum: this.skuNum ,spuSaleAttrList:JSON.stringify(this.spuSaleAttrList)},
        });
      } catch (error) {
        alert(error.message);
      }
